...
-- BOARD 테이블 샘플 데이터 입력
INSERT INTO BOARD (BOARD_SEQ,BOARD_RE_REF, BOARD_RE_LEV, BOARD_RE_SEQ, BOARD_WRITER, BOARD_SUBJECT, BOARD_CONTENT, INS_USER_ID, INS_DATE)
VALUES (BOARD_SEQ.nextval,0, 0, 0, '작성자', '게시글 제목_1', '게시글 내용_1', 'NONMEMBER', sysdate);
