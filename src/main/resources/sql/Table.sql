...
(
    ...
    STUDYPERIOD    DATE          NOT NULL,
    STUDYWEEKLY    DATE          ,
    STUDYTIMESTART TIME          NOT NULL,
    STUDYTIMEEND   TIME          NOT NULL,
    CONTENT     VARCHAR2(1000)
);

/* 테스트 데이터 */
INSERT INTO MENTOROOM (user_id, num, title, name, career, school, capacity, nowcapacity, studyPeriod, studyWeekly, studyTimeStart, studyTimeEnd, content)
values ('user01', mento_room_seq.nextval, 'StudyName', '멘토철수', '경력', '서울대학교', 30, 1, sysdate, 1,
