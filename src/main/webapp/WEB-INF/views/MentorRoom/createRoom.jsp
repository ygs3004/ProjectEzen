...
--%>
<style>
    #formTitle{font-size: 7vh;}
    #formDes{font-size: 2.5vh;}
...
<form action="#" onsubmit="return false" method="post">
    ...
    <div class="shadow p-3 mb-5 bg-white rounded formBody">
        ...
        <div class="useMove">
            <input type="text" class="form-control" id="studyPeriodStart" name="datefilter" value="" required>
         ...
         <div style="display: flex;justify-content: space-between;">
            ...
            <div class="useMove">
                <div><input type="time" class="form-control" id="studyTimeStart" value="0000" required>
                    <label for="studyTimeStart"><span>스터디 시간</span></label></div>
            </div>
            <div class="useMove">
                <input type="time" class="form-control" id="studyTimeEnd" value="" required>
